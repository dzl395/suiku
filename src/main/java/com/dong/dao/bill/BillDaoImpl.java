...
public class BillDaoImpl implements BillDao {
    ...
    public int add(Connection connection, Bill bill) throws Exception {
        ...
        int flag = 0;
        if (null != connection) {
            String sql = "insert into shuiku_bill (billCode,productName,productDesc," +
    ...
    public List<Bill> getBillList(Connection connection, Bill bill)
        ...
        if (connection != null) {
            ...
            sql.append("select b.*,p.proName as providerName from shuiku_bill b, shuiku_provider p where b.providerId = p.id");
    ...
    public int deleteBillById(Connection connection, String delId)
        ...
        int flag = 0;
        if (null != connection) {
            String sql = "delete from shuiku_bill where id=?";
            Object[] params = {delId};
            flag = BaseDao.execute(connection, sql, pstm,params);
    ...
    public Bill getBillById(Connection connection, String id) throws Exception {
        ...
        ResultSet rs = null;
        if (null != connection) {
            String sql = "select b.*,p.proName as providerName from shuiku_bill b, shuiku_provider p " +
    ...
    public int modify(Connection connection, Bill bill) throws Exception {
        ...
        PreparedStatement pstm = null;
        if (null != connection) {
            String sql = "update shuiku_bill set productName=?," +
    ...
    public int getBillCountByProviderId(Connection connection, String providerId)
        ...
        ResultSet rs = null;
        if (null != connection) {
            String sql = "select count(1) as billCount from shuiku_bill where" +
                    "	providerId = ?";
