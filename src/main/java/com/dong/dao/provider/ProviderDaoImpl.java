...
public class ProviderDaoImpl implements ProviderDao {
    ...
    public List<Provider> getProviderList(Connection connection, String proName, String proCode) throws Exception {
        ...
        if (connection != null) {
            ...
            sql.append("select * from shuiku_provider where 1=1 ");
    ...
    public int add(Connection connection, Provider provider) throws Exception {
        ...
        int flag = 0;
        if (null != connection) {
            String sql = "insert into shuiku_provider (proCode,proName,proDesc," +
    ...
    public int deleteProviderById(Connection connection, String delId) throws Exception {
        ...
        int flag = 0;
        if (null != connection) {
            String sql = "delete from shuiku_provider where id=?";
            Object[] params = {delId};
            flag = BaseDao.execute(connection, sql, pstm, params);
            BaseDao.closeResource(null, pstm, null);
        }
    ...
    public int modify(Connection connection, Provider provider) throws Exception {
        ...
        PreparedStatement pstm = null;
        if (null != connection) {
            String sql = "update shuiku_provider set proName=?,proDesc=?,proContact=?," +
    ...
    public Provider getProviderById(Connection connection, String id) throws Exception {
        ...
        ResultSet rs = null;
        if (null != connection) {
            String sql = "select * from shuiku_provider where id=?";
            Object[] params = {id};
